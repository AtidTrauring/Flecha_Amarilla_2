...
public class CBusquedas {
    ...
    public String buscarConductor(int id) throws SQLException {
        ArrayList<String> idConductor = cnslt.buscarCon1("SELECT conductor.Id_conductor FROM flecha_amarilla.conductor WHERE conductor.Id_persona = " + id);
    ...
    public int obtenIdFinalPersona() throws SQLException {
        ...
        return cnslt.obtieneIdFinal(consulta);
    }
